...
function DeepLearningCourses() {
  ...
  return (
    <div className='div-left'>
      <h4>Hung-yi Lee NTU - <a className="card-link" target="_blank" href={hung_yi_ml_link}>Machine Learning</a></h4>
      <h4>Hung-yi Lee NTU - <a className="card-link" target="_blank" href={hung_yi_ml2_link}>Next Step of Machine Learning</a></h4>
      <h4>Hung-yi Lee NTU - <a className="card-link" target="_blank" href={hung_yi_gan_link}>GAN</a></h4>
      <h4>Stanford - <a className="card-link" target="_blank" href={standford_DeepMultiTask_link}>Multi-Task and Meta-Learning</a></h4>
    </div>
  );
}
function TechCourses() {
  ...
  return (
    <div className='div-left'>
      <h4>How to Start a Startup - <a className="card-link" target="_blank" href={startup_link}>
        <span className="fa fa-external-link"></span>
        </a></h4>
      <h4>Hacker News - <a className="card-link" target="_blank" href={hacker_news_link}>
      <span className="fa fa-external-link"></span></a></h4>
      <h4>Future of Coding - <a className="card-link" target="_blank" href={future_coding_link}>
      <span className="fa fa-external-link"></span></a></h4>
    </div>
  );
}
function FinanceCourses() {
  ...
  return (
    <div className='div-left'>
      <h4>Underccover Billionaire - <a className="card-link" target="_blank" href={billionaire_link}>
        <span className="fa fa-external-link"></span></a></h4>
    </div>
  );
}
